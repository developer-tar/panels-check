    ...
    <form>
      ...
      <div class="grid grid-cols-2 gap-4 xxxl:gap-6">
        ...
        <div class="col-span-2 md:col-span-1">
          ...
          <input type="text"
            class="w-full text-sm  bg-secondary/5 dark:bg-bg3 !border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3"
            placeholder="Enter name" id="name" required value='tammy@yopmail.com' />
        </div>
        <div class="col-span-2 md:col-span-1">
          ...
          <select name="sort" class="nc-select full">
            <option value="day" selected>Male</option>
            <option value="week">Female</option>
            <option value="week">Other</option>
          </select>
        </div>
        <div class="col-span-2 md:col-span-1">
          <label for="old-password" class="md:text-lg font-medium block mb-4">
            Old Password
          </label>
          <input type="password"
            class="w-full text-sm  bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3"
            placeholder="Enter old password" id="old-password" required value='tammy' />
        </div>
        <div class="col-span-2 md:col-span-1">
          <label for="current-password" class="md:text-lg font-medium block mb-4">
            Current Password
          </label>
          <input type="password"
            class="w-full text-sm  bg-secondary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3"
            placeholder="Enter current password" id="confirm-password" required value='tammy' />
        </div>
