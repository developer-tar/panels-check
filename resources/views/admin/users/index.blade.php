                        ...
                        <tbody>
                            @foreach($users as $user)
                                <tr class="even:bg-secondary/5 dark:even:bg-bg3">
                                    ...
                                    <td class="py-2 px-6">
                                        <div class="flex items-center gap-3">
                                            <p class="font-medium mb-1">{{ $user['role'] }}</p>
                                        </div>
                                    ...
                                    <td class="py-2">
                                        ...
                                        <span class="block text-xs w-28 xxl:w-36 text-center rounded-[30px] dark:border-n500 border border-n30 py-2 bg-primary/10 @if($user['user_status'] == config('constants.user_approval_status_reverse.PENDING')) text-primary @elseif($user['user_status'] == config('constants.user_approval_status_reverse.APPROVED'))
                                        text-success-table @else  text-danger-table @endif
                                                                                                            dark:bg-bg3 ">
                                            {{ $user['user_status'] }}
                                        </span>
                                    </td>
