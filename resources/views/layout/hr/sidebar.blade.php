        ...
        <div class="logo-column">
            ...
            <div class="menu-container pb-28">
                <div class="menu-wrapper">
                    ...
                    <ul class="menu-ul">
                        <li class="menu-li">
                            <a href="{{route('hr.dashboard.index')}}" class="menu-link">
                        ...
                        <li class="menu-li">
                            ...
                            <ul class="submenu-hide submenu">
                                <li>
                                    <a href="{{ route('hr.user.index') }}" class="submenu-link">
                                        <i class="las la-minus text-xl"></i>
                                ...
                                <li>
                                    <a href="{{ route('hr.user.create') }}" class="submenu-link">
                                        <i class="las la-minus text-xl"></i>
                                        <span>Register</span>
                                    </a>
                                </li>
                        ...
                        <li class="menu-li">
                            ...
                            <ul class="submenu-hide submenu">
                                <li>
                                    <a href="{{ route('hr.benefit.index') }}" class="submenu-link">
                                        <i class="las la-minus text-xl"></i>
                                        <span>List/Manage</span>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="{{ route('hr.benefit.create') }}" class="submenu-link">
                                        <i class="las la-minus text-xl"></i>
                                        <span>Add</span>
                                    </a>
                                </li>
                        ...
                        <li class="menu-li">
                            ...
                            <ul class="submenu-hide submenu">
                                <li>
                                    <a href="{{ route('hr.notification.index') }}" class="submenu-link">
                                        <i class="las la-minus text-xl"></i>
                                        <span>List/Manage</span>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="{{ route('hr.notification.create') }}" class="submenu-link">
                                        <i class="las la-minus text-xl"></i>
                                        <span>Add</span>
                                    </a>
                                </li>
                        ...
                        <li class="menu-li">
                            ...
                            <ul class="submenu-hide submenu">
                                <li>
                                    <a href="{{ route('hr.analytics') }}" class="submenu-link">
                                        <i class="las la-minus text-xl"></i>
                                        <span>manage</span>
                                    </a>
                                </li>
