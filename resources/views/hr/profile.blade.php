                ...
                <div class="mt-6 xl:mt-8 grid grid-cols-2 gap-4 xxxxxl:gap-6">
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <input type="text"
                            ...
                            id="fname" placeholder="First Name" value="{{ old('user_name', $user?->first_name) }}" name="first_name" />
                        @error('first_name')
                        <div class="text-red-500 text-sm mt-1">
                            {{ $message }}
                        </div>
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <input type="text"
                            class="w-full text-sm bg-primary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3"
                            placeholder="Enter Last Name" id="lname" value="{{ old('last_name', $user?->last_name) }}" name="last_name" />
                        @error('last_name')
                        <div class="text-red-500 text-sm mt-1">
                            {{ $message }}
                        </div>
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text"
                            class="w-full text-sm bg-primary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3"
                            placeholder="Enter Phone" id="user_phone" value="{{ old('user_phone', $user?->phone)}}" name='user_phone' />
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text"
                            class="w-full text-sm bg-primary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3"
                            placeholder="Enter Phone" id="user_age" value="{{ old('user_age',$user?->age)}}" name="user_age" />
                        @error('user_age')
                        <div class="text-red-500 text-sm mt-1">
                            {{ $message }}
                        </div>
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="number"
                            ...
                            placeholder="Enter years" id="years" name="experience_in_years" value="{{ old('experience_in_years',$user?->experience_in_years) }}" name="experience_in_years" />
                    ...
                    <div class="col-span-2 ">
                        ...
                        <input type="number"
                            class="w-full text-sm  bg-secondary/5 dark:bg-bg3 !border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3"
                            placeholder="Enter month" id="month" value="{{ old('experience_in_month', $user?->experience_in_month) }}" name="experience_in_month" />
                    ...
                    <div class="col-span-2 ">
                        ...
                        <select id="gender" name="gender" class="nc-select full">
                            ...
                            <option value="{{ $name }}" {{ old('gender', $user?->gender) == $name ? 'selected' : '' }}>{{ $key }}</option>
            ...
            <div class="box xxl:p-8 xxxl:p-10">
                ...
                <div class="mt-6 xl:mt-8 grid grid-cols-2 gap-4 xxxxxl:gap-6">
                    <div class="col-span-2">
                        ...
                        <input type="text"
                            class="w-full text-sm bg-primary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3"
                            id="company_name_readonly" placeholder="First Name" value="{{$companyDetails->company_name}}" readonly />
                    </div>
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text"
                            class="w-full text-sm bg-primary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3"
                            id="company_website_url_readonly" placeholder="First Name" value="{{$companyDetails->website_url}}" readonly />
                    </div>
                    <div class="col-span-2">
                        ...
                        <input type="text"
                            class="w-full text-sm bg-primary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3"
                            id="company_rg_number_readonly" placeholder="First Name" value="{{$companyDetails->registration_number}}" readonly />
                    </div>
                    <div class="col-span-2 ">
                        ...
                        <textarea
                            ...
                            placeholder="Enter Description..." rows="5" id="description" name="description" readonly>{{ $companyDetails->description }}</textarea>

                    </div>
                </div>

                @if(!isset($companyId) && $companyId == null)
                <form class="mt-6 xl:mt-8 grid grid-cols-2 gap-4 xxxxxl:gap-6" method="post" action="{{route('company.profile')}}">
                    @csrf
                    <input type='hidden' value="{{config('constants.roles_inverse.hr')}}" name="role" />
                    <div class="col-span-2">
