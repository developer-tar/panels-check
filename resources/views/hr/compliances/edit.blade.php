...
@section('content')
  <div class="main-inner">
    ...
    <h2 class="h2">Update Compliance Alert</h2>
    </div>

    <div class="box mb-4 xxxl:mb-6">
    <div class="mb-6 pb-6 bb-dashed flex justify-between items-center">
      <h4 class="h4">update a compliance</h4>
    </div>
    ...
    <form class="flex flex-col h-full" method="POST">
      ...
      <div class="col-span-2 md:col-span-1">
        ...
        <option value="employee_contracts" selected>Employee Contracts</option>
      ...
      <div class="col-span-2 md:col-span-1">
        ...
        <option value="vendor" selected>Employee 1</option>
      ...
      <div class="col-span-2 md:col-span-1">
        ...
        <option value="vendor" selected>Employee 2</option>
      ...
      <div class="col-span-2 md:col-span-1">
        ...
        <option value="vendor" selected>Under Investigation</option>
      ...
      <div class="col-span-2 md:col-span-1">
        ...
        <option value="vendor" selected>Legal Team</option>
        </select>
      </div>
      {{-- Message --}}
      <div class="col-span-2 md:col-span-1">
        ...
        required>I have been subjected to inappropriate comments and actions by a co-worker, which have made me uncomfortable in the workplace</textarea>
      </div>
