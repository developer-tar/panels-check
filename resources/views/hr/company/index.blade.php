...
<div class="main-inner">
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4 lg:mb-8">
        ...
        <a href="{{route('hr.company.create')}}" class="btn-primary inline-flex items-center">
                                ...
                                <div class="flex justify-center">
                                    <div class="relative">
                                        ...
                                        <ul class="horiz-option popover-content">
                                            <li>
                                                <a href="{{route('employee.company.edit', 12)}}" class="single-option">
                                                    Edit
                                                </a>
                                            </li>
                                            <li>
                            ...
                            <td class="py-2">
                                <div class="flex justify-center">
                                    <div class="relative">
                                        ...
                                        <ul class="horiz-option popover-content">
                                            <li>
                                                <a href="{{route('hr.company.edit', 12)}}" class="single-option">
                                                    Edit
                                                </a>
                                            </li>
                                            <li>
