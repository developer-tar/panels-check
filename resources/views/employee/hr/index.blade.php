...
@section('content')
    <div class="main-inner">
        <div class="mb-6 flex flex-wrap items-center justify-between gap-4 lg:mb-8">
            <h2 class="h2">HR Management</h2>
            <a href="{{route('employee.hr.create')}}" class="btn-primary inline-flex items-center">
                <i class="las la-plus-circle text-base md:text-lg"></i>
                <span class="ml-1">Add an new HR</span>
            </a>
        </div>
                                    ...
                                    <div class="flex justify-center">
                                        <div class="relative">
                                            ...
                                            <ul class="horiz-option popover-content">
                                                <li>
                                                    <a href="{{route('employee.hr.edit', 12)}}" class="single-option">
                                                        Edit
                                                    </a>
                                                </li>
                                                <li>
