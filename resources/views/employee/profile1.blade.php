    ...
    <div class="grid grid-cols-12 gap-4 xxxxxl:gap-6">
        <div class="col-span-12 lg:col-span-6">
            <div class="box xxl:p-8 xxxl:p-10">
                ...
                <form class="mt-6 xl:mt-8 grid grid-cols-2 gap-4 xxxxxl:gap-6">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text"
                            class="w-full text-sm bg-primary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3"
                            placeholder="Enter Phone" value="24" id="phone" required />
                    </div>
                    <div class="col-span-2">
                        <label for="phone" class="md:text-lg font-medium block mb-4">
                        ...
                        <input type="text"
                            class="w-full text-sm bg-primary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3"
                            placeholder="Enter Phone" value="4 year 10 months" id="phone" required />
                    </div>
                    <div class="col-span-2">
                        <label for="phone" class="md:text-lg font-medium block mb-4">
            ...
            <div class="box xxl:p-8 xxxl:p-10 mt-3">
                ...
                <p class="text-lg font-medium mb-4">Company details</p>
                <div class="flex flex-wrap gap-6 xxl:gap-10 items-center bb-dashed mb-6 pb-6">
                    <img src="{{ asset('assets/images/placeholder.png') }}" width="120" height="120" class="rounded-xl"
                        alt="img" />
                    <div class="flex gap-4">
        ...
        <div class="col-span-12 lg:col-span-6">
            <div class="box xxl:p-8 xxxl:p-10 mb-6">
                ...
                <form class="mt-6 xl:mt-8 grid grid-cols-2 gap-4 xxxl:gap-6">
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <input type="text"
                            class="w-full text-sm bg-primary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3"
                            placeholder="Enter Address 1" value="Road 12, House 3, New York" id="address1" required />
                    </div>
                    <div class="col-span-2 md:col-span-1">
            ...
            <div class="box xxl:p-8 xxxl:p-10 mb-6">
                ...
                <form class="mt-6 xl:mt-8 grid grid-cols-2 gap-4 xxxl:gap-6">
                    ...
                    <div class="col-span-2 ">
                        <label for="salary" class="md:text-lg font-medium block mb-4">
                            Salary
                        </label>
                        <input type="text"
                            class="w-full text-sm bg-primary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3"
                            placeholder="Enter Address 1" id="salary" required value="20000" />
                    </div>
                    ...
                    <div class="col-span-2 ">
                        ...
                        <input type="text"
                            class="w-full text-sm bg-primary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3"
                            placeholder="Enter Address 2" id="personalLoan" required value="950" />
                    </div>
                    <div class="col-span-2 ">
                        ...
                        <input type="text"
                            class="w-full text-sm bg-primary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3"
                            placeholder="Enter Address 2" id="autoLoan" required value="300" />
                    </div>
                    <div class="col-span-2 ">
                        ...
                        <input type="text"
                            class="w-full text-sm bg-primary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3"
                            placeholder="Enter Address 2" id="creditCard" required value="1000" />
                    </div>
                    <div class="col-span-2 ">
                        ...
                        <input type="text"
                            class="w-full text-sm bg-primary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3"
                            placeholder="Enter Address 2" id="overdraft" required value="1000" />
                    </div>
                    <div class="col-span-2 ">
                        ...
                        <input type="text"
                            class="w-full text-sm bg-primary/5 dark:bg-bg3 border border-n30 dark:border-n500 rounded-3xl px-3 md:px-6 py-2 md:py-3"
                            placeholder="Enter Address 2" id="educationLoan" required value="960" />
                    </div>

                    <div class="col-span-2 flex pt-4 gap-4">
                        <button type="button" class="btn-primary px-5" onclick="calculateScore()">Save Changes</button>
                        <button class="btn-outline px-5">Cancel</button>
                    </div>
                    <h3>Results</h3>
                    <br>
                    <p><strong>Total Exposure (EAD):</strong> <span id="totalEAD">0</span></p>
                    <p><strong>DBR (EAD / Salary):</strong> <span id="dbr">0%</span></p>
                    <p><strong>Credit Limit:</strong> <span id="creditLimit">0</span></p>
                    <p><strong>Available Limit:</strong> <span id="availableLimit">0</span></p>
                </form>
            </div>
        </div>
...
<script>
    function calculateScore() {
        ...
        // Output results
        document.getElementById('totalEAD').textContent = totalEAD;
        document.getElementById('dbr').textContent = dbr + '%';
        document.getElementById('creditLimit').textContent = creditLimit;
        document.getElementById('availableLimit').textContent = availableLimit;
    }
</script>
