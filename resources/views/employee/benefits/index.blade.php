            ...
            <div class="box col-span-12 lg:col-span-6">
                ...
                @if($showCaseDetails)
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                        ...
                        @foreach($showCaseDetails as $details)
                            <div
                                class="p-6 rounded-2xl shadow-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 transition-all duration-300 hover:shadow-lg">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 text-sm text-gray-700 dark:text-gray-300">
                                    <div>
                                        <p class="text-xs uppercase tracking-wide text-gray-500 dark:text-gray-400 mb-1">Company
                                            Name</p>
                                        <p class="text-base font-semibold">{{ $details['company_name'] }}</p>
                                    </div>

                                    <div>
                                        <p class="text-xs uppercase tracking-wide text-gray-500 dark:text-gray-400 mb-1">Coverage
                                            Rate</p>
                                        <span
                                            class="inline-block px-3 py-1 text-sm font-medium bg-green-100 text-green-700 dark:bg-green-800 dark:text-green-100 rounded-full">
                                            {{ $details['coverage_rate'] }}
                                        </span>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-base font-semibold text-orange-600 dark:text-orange-400">
                                            {{ $details['company_email'] }}</p>
                                    </div>

                                    <div>
                                        <p class="text-xs uppercase tracking-wide text-gray-500 dark:text-gray-400 mb-1">Start
                                            Period</p>
                                        <p class="text-base font-semibold text-blue-600 dark:text-blue-400">
                                            {{ $details['start_period'] }}</p>
                                    </div>

                                    <div>
                                        <p class="text-xs uppercase tracking-wide text-gray-500 dark:text-gray-400 mb-1">End Period
                                        </p>
                                        <p class="text-base font-semibold text-red-600 dark:text-red-400">
                                            {{ $details['end_period'] }}</p>
                                    </div>
                                </div>
                            </div>
