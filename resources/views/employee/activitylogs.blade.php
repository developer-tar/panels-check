...
@section('content')
    <div class="main-inner">
        <div class="mb-6 flex flex-wrap items-center justify-between gap-4 lg:mb-8">
            <h2 class="h2">Tracking Activity Logs</h2>
        </div>
                    ...
                    <table class="w-full whitespace-nowrap" id="payment-account">
                        ...
                        <tbody>
                            <tr class="even:bg-secondary/5 dark:even:bg-bg3">
                                ...
                                <td class="py-2 px-6">
                                    <div class="flex items-center gap-3">
                                        <p class="font-medium mb-1">Tammy claimed have been approved</p>
                                    </div>
                            ...
                            <tr class="odd:bg-secondary/5 dark:even:bg-bg3">
                                <td class="py-2 px-6">
                                    <div class="flex items-center gap-3">
                                        2025-09-10 10:30
                                    </div>
                                ...
                                <td class="py-2 px-6">
                                    <div class="flex items-center gap-3">
                                        <p class="font-medium mb-1">John claimed have been Rejected</p>
                                    </div>
